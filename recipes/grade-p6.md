---
name: grade-p6
description: Grading guidelines specific to Úloha 6 of the linear algebra final exam. Covers problem statement, grading principles, full-credit solutions, and mathematical pitfalls.
---

# Grading Guidelines — Úloha 6

Use this skill when grading or instructing agents to grade **Úloha 6** from the June 2026 final exam. Pair with `/grade-problem` for the operational workflow.


## Exam structure

- **NMAG 112** (zimní i letní semestr, Lineární algebra 2): answers all four parts (a, b, c, d). **Max 20 points.**
...
Each part is worth **0–5 points**, or **?** (see below).

## Grading principles

**Score distribution:** The default score for any part is **0** (no valid progress) or **5** (complete, correct proof). Any intermediate score (1–4) must be explicitly justified in the comment — if you cannot articulate a precise reason, default to 0 or 5.

**Giving 4:** Imagine the student coming to argue it should be 5. You must be able to defend your deduction with a concrete, identifiable error or gap in an otherwise complete proof. If you cannot pinpoint what is wrong, give 5.
...
**Not cancelling $U^*U = I$:** Leaving the product $U^*U$ without simplification in a chain involving a unitary matrix is an error in the computation.
